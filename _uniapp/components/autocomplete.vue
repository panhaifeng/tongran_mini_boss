<template>
	<view class="cu-form-group">
		...
		<input class="uni-input" :id="id" :placeholder="placeholder" :value="myValue" @focus="onInput" @input="onInput" autocomplete="off"/>

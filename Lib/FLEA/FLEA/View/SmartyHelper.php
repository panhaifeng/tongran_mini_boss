 ...
 * @package Core
 * @version $Id: SmartyHelper.php 1009 2007-11-06 20:44:23Z qeeyuan $
 */
...
class FLEA_View_SmartyHelper
{
    ...
    function FLEA_View_SmartyHelper(& $tpl) {
        $tpl->register_function('url',          array(& $this, '_pi_func_url'), false);
        $tpl->register_function('webcontrol',   array(& $this, '_pi_func_webcontrol'), false);
        $tpl->register_function('_t',           array(& $this, '_pi_func_t'), false);
        $tpl->register_function('get_app_inf',  array(& $this, '_pi_func_get_app_inf'), false);
        $tpl->register_function('dump_ajax_js', array(& $this, '_pi_func_dump_ajax_js'), false);
